...
describe("Movies", () => {
  ...
  test("render the title of counter", () => {
    expect(wrapper.find("div").text()).toContain("This is counter app");
  });
